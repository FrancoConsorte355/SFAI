...
**Logs y dashboards:**  
- Muestran la diferencia entre la hora de ingreso de la pregunta y la generación de la respuesta, evidenciando la latencia con ejemplos concretos.  
- Se visualiza un patrón consistente de respuestas demoradas.
